...
export function ragEventFromMessage(body: unknown): ProofEvent | null {
  const message = body as {
    ...
    rag?: {
      ...
      method?: unknown;
      bestCosine?: unknown;
      minimumCosine?: unknown;
      automaticCosine?: unknown;
      decision?: unknown;
      reason?: unknown;
      selected?: unknown;
    };
  ...
  if (
    ...
    typeof rag.minimumCosine !== "number" ||
    typeof rag.automaticCosine !== "number" ||
    typeof rag.decision !== "string" ||
    ...
    rag.status === "grounded"
      ...
      : rag.status === "rejected"
        ...
        : rag.status === "skipped"
          ...
          : "RAG could not ground this turn";
  ...
  return {
    ...
    category: "rag",
    title,
    detail: `${rag.method} · ${readableScore(
      score,
      rag.minimumCosine,
      rag.automaticCosine,
    )} · ${rag.decision} · ${selection} · ${rag.reason}`,
    sources,
  };
}
